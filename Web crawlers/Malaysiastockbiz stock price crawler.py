"""
This script crawl data about all KLSE companies listed on MalaysiaStock.Biz website
"""
...
# we will scrape the open, high, low, and last prices and
# the update date for each company
